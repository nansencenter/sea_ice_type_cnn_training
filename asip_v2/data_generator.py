...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, list_IDs,shuffle_on_epoch_end, batch_size, dims_input, dims_output, dims_amsr2, dims_distance,
     output_var_name, input_var_names, distance_var_name, amsr2_var_names, prop=None):
        self.dims_input = dims_input
        self.dims_output = dims_output
        self.dims_amsr2 = dims_amsr2
        self.dims_distance = dims_distance
        self.batch_size = batch_size
        self.list_IDs = list_IDs
        self.input_var_names = input_var_names
        self.output_var_name = output_var_name
        self.distance_var_name = distance_var_name
    ...
    def w_x_y_z_initialization(self):
        # Initialization
        self.w = np.empty((self.batch_size, *self.dims_distance))
